<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0"
    ...
    @endif
            ...
            @auth
                <x-nav-link href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">
                    {{ __('dashboard') }}</x-nav-link>
            @else
                <x-nav-link href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">
